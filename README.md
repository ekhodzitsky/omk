...
Current source version: **v0.3.2**. We are intentionally **not publishing to crates.io yet**; install from GitHub release assets or from the GitHub repository.
...
| `omk goal` controller scaffold | Current scaffold: creates durable goal state, planning artifacts, task graph, local verification task evidence, bounded Wire-backed agent task evidence, controller review/security evidence, not-ready proof, and cancellation failure artifacts. |
...
Wire event evidence. `omk goal review` records controller review and bounded
secret-scan security evidence under `artifacts/reviews/`. Task mutation,
integration, specialist review loops, and ready proof generation are still
planned. The current `team run`, event log, gates, and
...
local gate evidence, bounded Wire-backed agent task evidence, controller
review/security evidence, and honest not-ready/cancelled proof artifacts. Goal
...
| Goal runtime | Durable goal state, plan/run/list/status/show/proof/verify/execute/review/cancel, planning artifacts, task graph with controller-owned, local verification, bounded Wire-backed agent, review, and security evidence, git evidence, local gate evidence, not-ready proof, and cancellation failure artifacts. Task mutation, specialist reviews, and integration loops are next. | Current Scaffold |
