...
| `goal.rs` | Goal controller scaffold commands: plan/run/list/status/show/proof/verify/execute/cancel, including local gates and the first bounded Wire-backed execution wave. |
