...
| `goal.rs` | Goal controller scaffold commands: plan/run/list/status/show/proof/verify/execute/review/cancel, including local gates, the first bounded Wire-backed execution wave, and controller review/security evidence. |
